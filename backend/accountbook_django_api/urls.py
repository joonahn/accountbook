"""accountbook_django_api URL Configuration
...
from accountbook.views import LoginView, LogoutView, CheckLoginView
...
urlpatterns = [
    ...
    path('accountbook/api/check_login/', CheckLoginView.as_view(), name='check-login'),
]
